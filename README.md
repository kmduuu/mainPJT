...
- 형상 관리자를 맡아 Git커밋 룰을 정하고, 폴더 구조를 정하였고 프로젝트 병합 관리 및 충돌 문제 해결을 하는 데 기여하였습니다.
- 클라우드도 잘 다룰 줄 아는 개발자가 되고 싶어 CI/CD 관리자도 맡고싶었지만, 아쉽게 할 수 없었습니다. 그러므로, 이번 프로젝트의 빌드와 배포를 자동화하는 연습을 하기 위해 이번에는 아마존 AWS로 운영관리를 할 것입니다.
